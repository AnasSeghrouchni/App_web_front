...
const BandeSuite = () => {
    return (
            <div className="bandesuite">
                    <Row>
                        <Col className='col-md-6 how-img'>
                            
                            
                            <img  src="./planete.png" className="rounded-circle img-fluid" alt=""/>
                        </Col>
                    ...
                    <Row>
                        ...
                        <Col className="col-md-6 how-img">
                            <img src="./icone-de-l-horloge-orange.png" className="rounded-circle img-fluid" alt=""/>
                        </Col>
                    </Row>
                    <Row>
                        <Col className="col-md-6 how-img">
                             <img src="./image_cartoon_style.png" className="rounded-circle img-fluid" alt=""/>
                        </Col>
                        <Col className="col-md-6">
